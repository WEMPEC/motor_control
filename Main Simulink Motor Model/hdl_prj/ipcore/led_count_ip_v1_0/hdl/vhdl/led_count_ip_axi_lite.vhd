-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdlcoder_led_blinking\led_count_ip_axi_lite.vhd
-- Created: 2018-04-09 19:23:35
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: led_count_ip_axi_lite
-- Source Path: led_count_ip/led_count_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY led_count_ip_axi_lite IS
...
END led_count_ip_axi_lite;


ARCHITECTURE rtl OF led_count_ip_axi_lite IS

  -- Component Declarations
  COMPONENT led_count_ip_addr_decoder
  ...
  COMPONENT led_count_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : led_count_ip_addr_decoder
    USE ENTITY work.led_count_ip_addr_decoder(rtl);

  FOR ALL : led_count_ip_axi_lite_module
    USE ENTITY work.led_count_ip_axi_lite_module(rtl);
  ...
  SIGNAL write_Blink_frequency_tmp        : std_logic_vector(3 DOWNTO 0);  -- ufix4
...
BEGIN
  u_led_count_ip_addr_decoder_inst : led_count_ip_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              write_Blink_frequency => write_Blink_frequency_tmp,  -- ufix4
              write_Blink_direction => write_Blink_direction  -- ufix1
              );

  u_led_count_ip_axi_lite_module_inst : led_count_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
  ...
  write_Blink_frequency <= write_Blink_frequency_tmp;
