-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdlcoder_led_blinking\led_count_ip_src_led_counter.vhd
...
ARCHITECTURE rtl OF led_count_ip_src_led_counter IS
  ...
  SIGNAL Blink_direction_1                : std_logic;
...
BEGIN
  ...
  Relational_Operator_relop1 <= '1' WHEN HDL_Counter1_out1 = alpha1_D_Lookup_Table_out1_1 ELSE
      '0';
  ...
  HDL_Counter_count_step <= to_unsigned(16#01#, 8) WHEN Blink_direction_1 = '1' ELSE
      to_unsigned(16#FF#, 8);
  HDL_Counter_count_next <= HDL_Counter_count + HDL_Counter_count_step;

  LED <= std_logic_vector(HDL_Counter_out1);
