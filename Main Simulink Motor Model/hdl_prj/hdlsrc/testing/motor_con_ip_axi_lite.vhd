-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\testing\motor_con_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: motor_con_ip_axi_lite
-- Source Path: motor_con_ip/motor_con_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY motor_con_ip_axi_lite IS
...
END motor_con_ip_axi_lite;


ARCHITECTURE rtl OF motor_con_ip_axi_lite IS

  -- Component Declarations
  COMPONENT motor_con_ip_addr_decoder
  ...
  COMPONENT motor_con_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : motor_con_ip_addr_decoder
    USE ENTITY work.motor_con_ip_addr_decoder(rtl);

  FOR ALL : motor_con_ip_axi_lite_module
    USE ENTITY work.motor_con_ip_axi_lite_module(rtl);
  ...
  SIGNAL write_Rotate_speed_tmp           : std_logic_vector(3 DOWNTO 0);  -- ufix4
...
BEGIN
  u_motor_con_ip_addr_decoder_inst : motor_con_ip_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              read_readback_speed_pwm => read_readback_speed_pwm,  -- ufix8
              read_readback_direction => read_readback_direction,  -- ufix8
              read_ReadBackAll => read_ReadBackAll,  -- ufix8
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable,  -- ufix1
              write_Rotate_speed => write_Rotate_speed_tmp,  -- ufix4
              write_Rotate_direction => write_Rotate_direction  -- ufix1
              );

  u_motor_con_ip_axi_lite_module_inst : motor_con_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
  ...
  write_Rotate_speed <= write_Rotate_speed_tmp;
